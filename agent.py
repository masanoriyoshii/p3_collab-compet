...
class Agent():
    ...
    def __init__(self, state_size, action_size, num_agents, agent_id, random_seed):
    ...
    def step(self, states, actions, rewards, next_states, dones, timestep):
        ...
        self.memory.add(states.reshape(1, -1), actions.flatten(), rewards[self.agent_id], next_states.reshape(1, -1), dones[self.agent_id])
    ...
    def act(self, states, add_noise=True):
        ...
        states = torch.from_numpy(states.reshape(1, -1)).float().to(device)
